...
import se.kth.karamel.core.running.model.tasks.ShellCommand;
import se.kth.karamel.core.running.model.tasks.Task;
import se.kth.karamel.core.running.model.tasks.Task.Status;

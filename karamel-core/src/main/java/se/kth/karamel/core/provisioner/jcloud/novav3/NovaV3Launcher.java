package se.kth.karamel.core.provisioner.jcloud.novav3;
 ...
 */
public final class NovaV3Launcher extends JCloudProvisionerInt {
  ...
  public String forkGroup(Cluster definition, ClusterRuntime runtime, String name) throws KaramelException {
    ...
    Set<String> ports = new HashSet<>(Settings.AWS_VM_PORTS_DEFAULT);
